...
// @Accept json
// @Produce json
// @Param input body models.InputFullRecipe true "json рецепта"
...
// @Produce json
// @Param id path int true "ID рецепта"
// @Param input body models.InputFullRecipe true "New data for recipe"
// @Success 200 {object} string
// @Failure 400,404 {object} errorResponse
// @Failure 500 {object} errorResponse
// @Failure default {object} errorResponse
...
// @Accept json
// @Produce json
// @Param input body IngredientsInput true "Список ингредиентов"
// @Success 200 {array} models.SimplifiedRecipe `json:"data"`
// @Failure 400,404 {object} errorResponse
// @Failure 500 {object} errorResponse
// @Failure default {object} errorResponse
